...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    private final List<String> allowedAdressesList = Arrays.asList("https://pixel-war.netlify.app", "http://127.0.0.1:5500"); //, "https://pixel-war.netlify.app" "http://localhost:3000", "http://localhost:3001", "http://localhost:3002"
